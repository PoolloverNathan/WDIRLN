...
trait ApplyStyle where Self: Sized {
    type Styled;
...
impl CharType for u8 {
    ...
    fn chtype(self) -> Self::Chtype {
        ...
        ChtypeChar::new(ascii::AsciiChar::from_ascii(self).expect("Internal error: invalid ASCII character"))
    }
}
...
impl<I> ApplyStyle for I where I: CharType, I::Chtype: ops::BitOr<Attributes, Output = I::Chtype> {
